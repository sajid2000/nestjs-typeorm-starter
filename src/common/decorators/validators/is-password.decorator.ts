...
import { MaxLength, MinLength, registerDecorator, ValidatorConstraint } from "class-validator";
...
export function IsPasswordField(validationOptions?: ValidationOptions & { minLength?: number; maxLength?: number }) {
  return applyDecorators(MinLength(6), MaxLength(40), IsPassword(validationOptions));
}
